            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if ($(child).attr('class') == 'fas fa-trash') {
                        ...
                        toastr.error("Prodosul a fost eliminat din cos. Valore cos: " + response.totalPrice + ' Lei');
                    } else {
                        ...
                        toastr.success("Prodosul a fost adaugat in cos. Valore cos: " + response.totalPrice + ' Lei');
